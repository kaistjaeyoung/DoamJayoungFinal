...
public class Frag3 extends Fragment{
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View root3view = inflater.inflate(R.layout.frag3_layout, container, false);
        super.onCreateView(inflater, container, savedInstanceState);
        mGridview = (GridView) root3view.findViewById(R.id.gridview_frag3);
        ...
        mGridview.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int pos, long id) {
                ...
                Intent intent = new Intent(getActivity().getApplicationContext(), Paint.class);
                intent.putExtra("path", path);
                startActivity(intent);
            }
        });
    ...
    private static class GridDataAsyncTask_Frag3 extends AsyncTask<Void, Void, SimpleAdapter> {
        private int mode;
        ContentResolver contentResolver = mContext.getContentResolver();

        public GridDataAsyncTask_Frag3(int mode_inp) {
            mode = mode_inp;
        }
        ...
        protected SimpleAdapter doInBackground(Void... params) {
            ...
            SimpleAdapter adapter = new SimpleAdapter(mContext.getApplicationContext(),
                    GridImageList,
                    R.layout.gridview_layout_frag3,
                    new String[]{"thumb"},
                    new int[]{R.id.thumb});
            return adapter;
        }
    ...
    private static void exe_async(int mode) {
        GridDataAsyncTask_Frag3 mGridDataAsyncTaskFrag2 = new GridDataAsyncTask_Frag3(mode);
